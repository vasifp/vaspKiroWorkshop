...
- [x] 1. Create Repository layer
  - [x] 1.1 Create `backend/repository.py` with DynamoDB operations
...
- [x] 2. Create Services layer
  - [x] 2.1 Create `backend/services.py` with business logic
...
- [x] 5. Deploy and verify
  - [x] 5.1 Deploy refactored application
    - Run `cdk deploy` to update Lambda
    - _Requirements: 4.1, 4.2, 4.3_
  - [x] 5.2 Verify all endpoints work correctly
